package com.socarras.cardsservice.controller;
...
import com.socarras.cardsservice.dto.ErrorResponseDto;
import com.socarras.cardsservice.dto.ResponseDto;
...
@Tag(name = "Cards API for EazyBank", description = "CRUD REST APIs for card details")
public class CardsController {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
        ...
        log.info("fetchCardDetails start");
        CardsDto cardsDto = cardsServiceImpl.fetchCard(mobileNumber);
        log.info("fetchCardDetails end");
        return ResponseEntity
    ...
    public ResponseEntity<ResponseDto> updateCardDetails(@Valid @RequestBody CardsDto cardsDto) {
        boolean isUpdated = cardsServiceImpl.updateCard(cardsDto);
        if (isUpdated) {
            return ResponseEntity
                    .status(HttpStatus.OK)
